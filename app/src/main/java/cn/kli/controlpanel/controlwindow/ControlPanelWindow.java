package cn.kli.controlpanel.controlwindow;
...
import cn.kli.controlpanel.framework.manager.BatteryStatusManager;
import cn.kli.controlpanel.framework.widget.RoundProgressBar;
...
public class ControlPanelWindow extends BaseFloatWindow {
    ...
    private void freshView(){
        int battery = (int) (BatteryStatusManager.getInstance(getContext()).getValue() * 100f);
